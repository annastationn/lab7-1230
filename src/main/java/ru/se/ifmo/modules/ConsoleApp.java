...
import ru.se.ifmo.commands.Command;
...
//        this.save = commands[7];
        this.executeScript = commands[7];
        this.exit = commands[8];
        this.removeGreaterKeyNull = commands[9];
        this.removeLower = commands[10];
        this.history = commands[11];
        this.minByName = commands[12];
        this.printUniqueAnnualTurnover = commands[13];
        this.filterGreaterThanType = commands[14];
    }
